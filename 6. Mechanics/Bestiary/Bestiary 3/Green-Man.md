...
abilities_mid:
  ...
  - name: "Green Caress"
    desc: " ([[aura]], [[incapacitation]], [[plant]], [[primal]], [[transmutation]]);  60 feet. Living creatures in the area other than plants slowly transform into non-creature plants. The green man can exclude creatures from this effect, but they must be aware of a creature's presence and location to do so. A non-plant creature in the area must attempt a DC 45 Fortitude save immediately before the start of its turn.\n__Critical Success__ The creature is unaffected, or if it is [[conditions#slowed|slowed]] by green caress, it reduces its [[conditions#slowed|slowed]] value by 2.\n__Success__ The creature is unaffected, or if it is [[conditions#slowed|slowed]] by green caress, it reduces its [[conditions#slowed|slowed]] value by 1.\n__Failure__ The creature becomes [[conditions#slowed|slowed 1]], or if it was already [[conditions#slowed|slowed]] by green caress, increases the [[conditions#slowed|slowed]] value by 1, as their body transforms more and more into a non-creature plant. If the creature ever becomes [[conditions#slowed|slowed]] to the point they have no actions left for their turn, they become an inanimate plant, a condition that can only be reversed by primal phenomenon or similarly powerful magic.\n__Critical Failure__ As failure, except the creature becomes [[conditions#slowed|slowed 2]] (or increases the condition value by 2)."
  - name: "Root In Place"
