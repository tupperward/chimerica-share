...
abilities_bot:
  ...
  - name: "Shadowed Blade"
    desc: "⬺ ([[darkness]]);  The vanguard makes a melee [[Strike]], channeling shadowy essence into their weapon or unarmed attack to envelop the target. If the [[Strike]] hits, the target must succeed at a DC 19 Fortitude save or become [[conditions#blinded|blinded]] until the end of its next turn."
