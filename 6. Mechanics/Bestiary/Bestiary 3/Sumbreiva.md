...
abilities_mid:
  ...
  - name: "Hunter's Triumph"
    desc: "⬲ ([[auditory]], [[emotion]], [[fear]], [[mental]]); __Trigger__ The sumbreiva kills a creature __Effect__  The sumbreiva lets out a triumphant, bone-chilling howl. Every enemy in a 30-foot emanation must succeed at a DC 36 Will save or become [[conditions#frightened|frightened 3]] (and [[conditions#fleeing|fleeing]] as long as it's [[conditions#frightened|frightened]] on a critical failure)."
abilities_bot:
  - name: "Claim Trophy"
  ...
  - name: "Huntblade Brutality"
    desc: "  The sumbreiva's huntblade deals an additional 2d8 (2d8) damage to [[conditions#drained|drained]], [[6. Mechanics/Rules/conditions.md#Flat-footed|flat-footed]], or [[conditions#frightened|frightened]] creatures."
  - name: "Whip Drain"
    desc: "⬻ ([[arcane]], [[death]], [[necromancy]]); __Requirements__ The sumbreiva has a creature [[conditions#grabbed|grabbed]] with their shadow whip  __Effect__  The [[conditions#grabbed|grabbed]] creature must succeed at a DC 38 Fortitude save or become [[conditions#drained|drained 2]] ([[conditions#drained|drained 3]] on a critical failure). If the creature is already [[conditions#drained|drained]], this increases its [[conditions#drained|drained]] value instead, to a maximum of [[conditions#drained|drained 4]]."
