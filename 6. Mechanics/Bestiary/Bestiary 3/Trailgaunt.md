...
abilities_mid:
  - name: "Pained Muttering"
    desc: " ([[auditory]], [[aura]], [[emotion]], [[fear]]);  10 feet. The trailgaunt's constant mutters and groans of pain are deeply unsettling. Each creature that starts its turn in the aura must succeed at a DC 20 Fortitude save or become [[conditions#frightened|frightened 1]] ([[conditions#frightened|frightened 2]] on a critical failure). The creature is then temporarily immune for 1 minute."
abilities_bot:
  - name: "Create Spawn"
