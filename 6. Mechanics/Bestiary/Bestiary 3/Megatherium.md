...
abilities_mid:
  - name: "Musk"
    desc: " ([[aura]], [[olfactory]]);  20 feet. A creature entering the aura or starting its turn in the aura must succeed at a DC 19 Fortitude save or become [[conditions#sickened|sickened 1]]. While inside the aura, affected creatures take a –1 circumstance penalty to recover from the [[conditions#sickened|sickened]] condition. A creature that succeeds at its save is temporarily immune for 1 minute."
abilities_bot:
  - name: "Rend"
    desc: "⬻ ([[claw]]);  (page 306)"
