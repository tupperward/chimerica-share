...
abilities_bot:
  - name: "Dab"
    desc: "⬻ ([[enchantment]], [[manipulate]], [[mental]], [[occult]]); __Requirements__ The blood painter is within reach of an enemy taking [[conditions#persistent damage|persistent bleed damage]]  __Effect__  The blood painter touches the creature and applies blood to one of their four claws; the blood remains fresh for 1 minute. The target must succeed at a DC 28 Will save or become [[conditions#fascinated|fascinated]] with the blood painter."
  - name: "Paint"
...
attacks:
  - name: Melee
    desc: "⬻ claw +20 ([[agile]], [[reach|reach 10 feet]]); __Damage__ 3d8+8 (3d8+8) slashing plus 1d8 (1d8) [[conditions#persistent damage|persistent bleed]]"
