...
abilities_bot:
  - name: "Grasping Bites"
    desc: "⬺ ([[attack]]);  The cobbleswarm attempts an [[Athletics]] check and compares the result to the Fortitude DC of each creature in its space. This counts as two attacks for the cobbleswarm's multiple attack penalty.\n__Critical Success__ The creature falls [[conditions#prone|prone]], takes 1d6 (1d6) bludgeoning damage, and is [[conditions#grabbed|grabbed]] by the cobbleswarm until the end of the cobbleswarm's next turn.\n__Success__ The creature falls [[conditions#prone|prone]]."
