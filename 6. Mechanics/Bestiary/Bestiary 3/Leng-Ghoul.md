...
abilities_bot:
  ...
  - name: "Paralysis"
    desc: " ([[incapacitation]], [[occult]], [[necromancy]]);  Any living creature hit by a Leng ghoul's attack must succeed at a DC 28 Fortitude save or become [[conditions#paralyzed|paralyzed]]. It can attempt a new save at the end of each of its turns, and the DC cumulatively decreases by 1 on each such save."
  - name: "Sneak Attack"
    desc: "  A Leng ghoul deals an extra 2d6 (2d6) precision damage to [[6. Mechanics/Rules/conditions.md#Flat-footed|flat-footed]] creatures."
