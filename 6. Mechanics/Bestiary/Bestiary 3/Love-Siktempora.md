...
abilities_bot:
  - name: "Heartsong"
    desc: " ([[emotion]], [[enchantment]], [[mental]], [[occult]]);  A creature that takes mental damage from the love siktempora's emotional bolt must succeed at a DC 37 Will save or become [[conditions#fascinated|fascinated]] by the siktempora until the end of the target's next turn. [[conditions#hostile|Hostile]] actions don't end this [[conditions#fascinated|fascinated]] condition."
