...
abilities_bot:
  ...
  - name: "Raptor Dive"
    desc: "⬽ __Requirements__ The maftet is flying at least 10 feet above the target  __Effect__  The maftet [[Fly|Flies]] up to twice their fly Speed and makes a Paired Strike at the end of the movement. If both [[Strike|Strikes]] hit, the target is also knocked [[conditions#prone|prone]]."
