...
abilities_bot:
  - name: "Feral Gnaw"
    desc: "⬻  Each enemy in the swarm's space takes 2d6 (2d6) bludgeoning, 2d6 (2d6) piercing, and 2d6 (2d6) slashing damage (DC 32 basic Reflex save). A creature that fails its saving throw also takes 1d10 (1d10) [[conditions#persistent damage|persistent bleed damage]]."
  - name: "Frightening Howl"
    desc: "⬻ ([[auditory]], [[emotion]], [[enchantment]], [[fear]], [[mental]]);  The feral skull swarm emits a terrifying howl. Each creature within 60 feet must succeed at a DC 32 Will save or become [[conditions#frightened|frightened 2]] ([[conditions#frightened|frightened 3]] and [[conditions#fleeing|fleeing]] for 1 round on a critical failure). Whether it succeeds or fails its save, a creature is temporarily immune to."
  - name: "Frightening"
