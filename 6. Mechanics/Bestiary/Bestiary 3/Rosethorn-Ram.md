...
abilities_bot:
  - name: "Broken Thorns"
    desc: "⬻ __Requirements__ The rosethorn ram damaged a creature with its horns on its most recent action this turn  __Effect__  The ram breaks off one of the thorny protrusions of its horns and leaves it in the wound, dealing 1d6 (1d6) [[conditions#persistent damage|persistent bleed damage]]."
