...
abilities_bot:
  - name: "Drain Blood"
    desc: "⬻ __Requirements__ The sabosan has a creature [[conditions#grabbed|grabbed]]  __Effect__  The sabosan drains blood from the creature. The creature must succeed at a DC 23 Fortitude save or become [[conditions#drained|drained 1]]. The sabosan gains a number of temporary Hit Points equal to the number of Hit Points lost by the creature."
  - name: "Fell Shriek"
    desc: "⬺ ([[auditory]]);  The sabosan emits a deafening cry in a 30-foot cone. Non-sabosan creatures in this area must each succeed at a DC 23 Fortitude save or be [[conditions#deafened|deafened]] for 1 minute."
...
attacks:
  - name: Melee
    desc: "⬻ jaws +15 ([[finesse]]); __Damage__ 2d10+4 (2d10+4) piercing plus 1 [[conditions#persistent damage|persistent bleed]]"
  - name: Melee
