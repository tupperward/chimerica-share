...
abilities_bot:
  - name: "Blinding Sulfur"
    desc: " ([[incapacitation]]);  A sulfur zombie burns with putrid inner fire. A creature hit by a sulfur zombie's fist [[Strike]] must attempt a DC 22 Fortitude save. On a failure, the creature is [[conditions#blinded|blinded]] for 1 round, or for 1 minute on a critical failure."
...
attacks:
  - name: Melee
    desc: "⬻ fist +17 __Damage__ 2d6+5 (2d6+5) bludgeoning plus 1d6 (1d6) [[conditions#persistent damage|persistent fire]] and blinding sulfur"
