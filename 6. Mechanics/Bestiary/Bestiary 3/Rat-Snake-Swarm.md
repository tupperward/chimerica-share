...
abilities_mid:
  - name: "Mass Wriggle"
    desc: "⬲ __Trigger__ The rat snake swarm takes damage from a melee [[Strike]] __Effect__  Snakes slither up and around the creature's weapon and limbs. The target must succeed at a DC 15 Will save or become [[conditions#frightened|frightened 1]]."
abilities_bot:
