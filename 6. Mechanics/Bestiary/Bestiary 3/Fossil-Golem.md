...
abilities_bot:
  - name: "Fossilization"
    desc: " ([[arcane]], [[incapacitation]], [[transmutation]]);  The first time each round a creature takes damage from the fossil golem's jaws, the target must attempt a DC 32 Fortitude save. If it fails and has not already been [[conditions#slowed|slowed]] by this ability, it becomes [[conditions#slowed|slowed 1]] for 1 minute. If the creature was already [[conditions#slowed|slowed]] by this ability, a failed save causes it to be [[conditions#petrified|petrified]] permanently."
  - name: "Reassemble"
