...
abilities_bot:
  ...
  - name: "Spring Up"
    desc: "⬺ __Requirements__ The vanara disciple is [[conditions#prone|prone]]  __Effect__  The vanara [[Stand|Stands]], then can immediately [[Step]] twice. The [[Stand]] action doesn't trigger reactions."
