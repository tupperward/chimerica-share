...
abilities_mid:
  - name: "Fade Away"
    desc: "⬲ __Requirements__ The fading fox is in natural surroundings __Trigger__ A creature within 30 feet that the fading fox is aware of either moves toward the fox or targets it with an ability __Effect__  The fading fox Hides. If its [[Stealth]] check result meets or exceeds the triggering creature's [[Perception]] DC, the fading fox is [[conditions#hidden|hidden]] to that creature. The fading fox can use this reaction even if it is being [[conditions#observed|observed]]."
abilities_bot:
  - name: "Leaping Pounce"
    desc: "⬻  The red fox either [[Stride|Strides]] or Leaps up to its Speed and makes a [[Strike]] at the end of that movement. If the fox began this action [[conditions#hidden|hidden]], it remains [[conditions#hidden|hidden]] until after this ability's [[Strike]]."
  - name: "Sneak Attack"
  ...
  - name: "Vanish into the Wilds"
    desc: "⬺ __Requirements__ The fading fox is in natural surroundings  __Effect__  The fading fox [[Step|Steps]], then Hides, then [[Sneak|Sneaks]]. It can take this [[Step]] into natural [[terrain|difficult terrain]] and can [[Hide]] in this way even if it is being [[conditions#observed|observed]]."
