...
abilities_bot:
  - name: "Swarming Chimes"
    desc: "⬻  The swarm deals 4d6 (4d6) slashing damage plus 2d6 (2d6) sonic damage to each enemy in the swarm's space (DC 33 basic Reflex save). On a critical failure, the enemy is also [[conditions#deafened|deafened]] for 1 minute."
