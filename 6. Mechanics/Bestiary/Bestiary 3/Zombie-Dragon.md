...
abilities_top:
  - name: "Slow"
    desc: "  A zombie dragon is permanently [[conditions#slowed|slowed 1]] and can't use reactions."
abilities_bot:
  - name: "Breath Weapon"
    desc: "⬺  The zombie dragon breathes a wave of fetid viscera that deals 5d6 (5d6) bludgeoning and 5d6 (5d6) poison damage (DC 28 basic Reflex save). A creature that critically fails is also [[conditions#sickened|sickened 2]]. The zombie dragon can't use Breath Weapon again for 1d4 (1d4) rounds."
