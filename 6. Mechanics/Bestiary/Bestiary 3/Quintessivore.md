...
abilities_bot:
  ...
  - name: "Suspend Soul"
    desc: "⬻ ([[arcane]], [[necromancy]]);  The quintessivore suspends the life processes of a [[conditions#dying|dying]] creature within 15 feet of it. The creature can't decrease or increase its HP or [[conditions#dying|dying]] value for 10 minutes. The creature can attempt a DC 29 Will save to avoid this effect. If the creature receives magical healing, it can attempt a new save, ending the effect and being healed normally on a success. The effect ends if the quintessivore uses Suspend Soul again."
  - name: "Tattered Soul"
    desc: "  A creature hit by the quintessivore's blade-leg [[Strike]] must succeed at a DC 29 Fortitude save or become [[conditions#drained|drained 1]] ([[conditions#drained|drained 2]] on a critical failure). If the creature is already [[conditions#drained|drained]], it's immune to this effect."
