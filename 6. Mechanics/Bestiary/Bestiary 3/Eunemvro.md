...
abilities_bot:
  ...
  - name: "Tide of Creation"
    desc: "⬺ ([[evocation]], [[light]], [[occult]], [[positive]]); __Requirements__ The eunemvro isn't [[conditions#fatigued|fatigued]]  __Effect__  The eunemvro channels from their soul a blast of searing positive energy, bathing their enemies in a wave of blinding light and cosmic power. The eunemvro creates either a 10-foot cone or a 30-foot line, dealing 6d8 (6d8) positive damage (DC 22 basic Fortitude save). A creature that critically fails its save is [[conditions#blinded|blinded]] for 1d4 (1d4) rounds. After using this ability, the eunemvro becomes [[conditions#fatigued|fatigued]]."
