...
abilities_bot:
  - name: "Drain Life"
    desc: "  When a tzitzimitl's claw [[Strike]] deals damages to a living creature, the tzitzimitl gains 20 temporary Hit Points, and the target must succeed at a DC 41 Fortitude save or become [[conditions#drained|drained 2]]. Further damage dealt by a tzitzimitl's claw [[Strike]] increases the value of the [[conditions#drained|drained]] condition by 2 on a failed save, to a maximum of [[conditions#drained|drained 4]]."
  - name: "Eclipse"
    desc: "⬺ ([[cold]], [[occult]]);  The tzitzimitl casts darkness and drains the heat and warmth from the [[darkness]] spell's area, and each creature within the spell's area must attempt a DC 41 Fortitude save.\n__Critical Success__ The creature takes 4d8 (4d8) cold damage.\n__Success__ The creature takes 8d8 (8d8) cold damage and is [[conditions#slowed|slowed 1]] for 1 round.\n__Failure__ The creature takes 16d8 (16d8) cold damage and is [[conditions#slowed|slowed 1]] for 1 minute.\n__Critical Failure__ The creature takes 16d8 (16d8) cold damage, is [[conditions#slowed|slowed 2]] for 1 minute, and is [[conditions#doomed|doomed 1]]."
