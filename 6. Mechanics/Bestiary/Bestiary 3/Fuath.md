...
abilities_mid:
  - name: "Vulnerable to Sunlight"
    desc: "  A fuath becomes [[conditions#drained|drained 1]] (or increases its [[conditions#drained|drained]] condition by 1) after every consecutive hour they're exposed to sunlight. Being submerged in more than a foot of water prevents the sunlight from harming the fuath."
abilities_top:
  - name: Items
    desc: "darts (6);"
abilities_bot:
