...
abilities_bot:
  ...
  - name: "Breath Weapon"
    desc: "⬺ ([[arcane]], [[evocation]], [[fire]]);  The dragon breathes a blast of fire that explodes in a 20-foot burst within 40 feet, dealing 7d6 (7d6) fire damage (DC 25 basic Reflex save). Creatures that fail the save also take 1d6 (1d6) [[conditions#persistent damage|persistent fire damage]]. The dragon can't use Breath Weapon again for 1d4 (1d4) rounds."
  - name: "Coiling Frenzy"
