...
abilities_bot:
  - name: "Inkstain"
    desc: "  When the scalescribe deals damage to a creature with their fountain pen, the creature takes 1d4 (1d4) [[conditions#persistent damage|persistent poison damage]]. When a creature taking this damage attempts to take an action with the [[concentrate]] trait, it must succeed at a DC 5 flat check or the action is disrupted."
