...
abilities_mid:
  ...
  - name: "Mortic Ferocity"
    desc: "⬲  As Ferocity (page 305), but the lifeleecher is also surrounded by visibly flickering fragments of the souls they've consumed, becoming [[conditions#concealed|concealed]] until the end of their next turn."
  - name: "Soul Feast"
...
abilities_bot:
  ...
  - name: "Leech Essence"
    desc: " ([[divine]], [[necromancy]]);  When the lifeleecher damages a living or undead creature with their jaws [[Strike]], they drain the target's life essence. The lifeleecher gains 5 temporary Hit Points that last for 1 minute, and the target must succeed at a DC 24 Fortitude save or become [[conditions#drained|drained 1]] if living, or [[conditions#stunned|stunned 1]] if undead. If the target was already [[conditions#drained|drained]] or [[conditions#stunned|stunned]], the value of this condition instead increases by 1, to a maximum of 3."
...
attacks:
  ...
  - name: Melee
    desc: "⬻ claw +20 ([[agile]]); __Damage__ 2d8+6 (2d8+6) slashing plus 1d6 (1d6) [[conditions#persistent damage|persistent bleed]]"
  - name: Ranged
