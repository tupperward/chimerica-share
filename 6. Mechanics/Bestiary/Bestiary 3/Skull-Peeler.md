...
abilities_bot:
  - name: "Anticoagulant"
    desc: "  The skull peeler's razor-sharp tongue is coated in an anticoagulant substance that makes wounds it inflicts particularly hard to close. The DC of the flat check to end the [[conditions#persistent damage|persistent bleed damage]] from a skull peeler's tongue is 16, or 11 with appropriate assistance."
...
attacks:
  - name: Melee
    desc: "⬻ tongue +17 ([[agile]], [[fatal|fatal d12]], [[reach|reach 10 feet]]); __Damage__ 2d4+8 (2d4+8) slashing plus 1d8 (1d8) [[conditions#persistent damage|persistent bleed]]"
  - name: Melee
