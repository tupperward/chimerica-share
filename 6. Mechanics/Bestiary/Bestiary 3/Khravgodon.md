...
abilities_mid:
  - name: "Feign Death"
    desc: "⬲ __Trigger__ The opossum is reduced below 70 HP __Effect__  The khravgodon collapses. It is [[6. Mechanics/Rules/conditions.md#Flat-footed|flat-footed]] and can use actions that require only its mind, but any other action ends the ruse. A successful DC 18 [[Perception]] check to [[Seek]] or [[Medicine]] check to [[Recall Knowledge]] is required to determine that the animal is not, in fact, dead."
...
abilities_bot:
  - name: "Crush Chitin"
    desc: "⬻ __Requirements__ The khravgodon has a creature [[conditions#grabbed|grabbed]] or [[conditions#restrained|restrained]]  __Effect__  The khravgodon bites the creature, dealing 2d12+9 (2d12+9) piercing damage (DC 28 basic Fortitude save) that ignores the first 5 of the target's Hardness or resistance to physical damage. On a failed save, the target also takes a –2 circumstance penalty to AC for 1 round."
  - name: "Grasping Tail"
    desc: "  A khravgodon can drag a Large or smaller creature it has [[conditions#grabbed|grabbed]] with its tail along with it when it [[Stride|Strides]]."
