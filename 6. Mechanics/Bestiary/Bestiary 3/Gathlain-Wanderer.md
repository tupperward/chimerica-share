...
abilities_bot:
  ...
  - name: "Rootbound"
    desc: "⬺ __Requirements__ The gathlain isn't using their wings to fly  __Effect__  The gathlain sprouts woody roots from the tips of their wings that bind an adjacent creature's limbs. The target must succeed at a DC 17 Fortitude save or be [[conditions#grabbed|grabbed]] by the gathlain's wing-tip vines until the start of the gathlain's next turn."
