...
abilities_bot:
  ...
  - name: "Tickle"
    desc: "  The nightgaunt can use its tail to tickle a foe with horrible efficiency. A creature hit by its tail [[Strike]] must attempt a DC 21 Fortitude save; if the creature is [[conditions#grabbed|grabbed]] by the nightgaunt, it uses the outcome one degree of success worse than the result it rolled.\n__Critical Success__ The creature is unaffected and is temporarily immune for 1 minute.\n__Success__ The creature is overcome with laughter and can't perform reactions for 1 round.\n__Failure__ As success, and the creature is [[conditions#sickened|sickened 1]].\n__Critical Failure__ As success, and the creature is [[conditions#sickened|sickened 2]] and can't speak for 1 round."
