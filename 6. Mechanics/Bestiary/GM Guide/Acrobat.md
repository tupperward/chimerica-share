...
abilities_top:
  - name: "Steady Balance"
    desc: "  When the acrobat rolls a success on an [[Acrobatics]] check, they get a critical success instead. They aren't [[#]] when attempting to [[Balance]] and can attempt an [[Acrobatics]] check instead of a Reflex save to [[Grab an Edge]]."
  - name: Items
...
abilities_bot:
  - name: "Sneak Attack"
    desc: "  The acrobat deals an extra 1d6 (1d6) precision damage to [[6. Mechanics/Rules/conditions.md#Flat-footed|flat-footed]] creatures."
