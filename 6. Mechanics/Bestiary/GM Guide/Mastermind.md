...
abilities_bot:
  - name: "Scoundrel's Feint"
    desc: "  When the mastermind successfully [[Feint|Feints]], the target is [[6. Mechanics/Rules/conditions.md#Flat-footed|flat-footed]] against the mastermind's melee attacks until the end of the mastermind's next turn. On a critical success, the target is [[6. Mechanics/Rules/conditions.md#Flat-footed|flat-footed]] against all melee attacks for that time, not just the mastermind's."
  - name: "Sneak Attack"
    desc: "  The mastermind deals an extra 1d6 (1d6) precision damage to [[6. Mechanics/Rules/conditions.md#Flat-footed|flat-footed]] creatures."
