...
abilities_bot:
  - name: "Fascinating Dance"
    desc: "⬻ __Frequency__ once per round  __Effect__  The dancer [[Stride|Strides]] up to their Speed. Once during this movement, when the dancer is adjacent to a creature, the dancer can make that creature attempt a DC 17 Will save. On a failure, that creature is [[conditions#fascinated|fascinated]] with the dancer until the end of its next turn."
abilities_top:
  - name: Items
