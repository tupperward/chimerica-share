...
abilities_bot:
  - name: "Pitch Bale"
    desc: "⬻ __Requirements__ The farmer's last action was a successful pitchfork [[Strike]]  __Effect__  The farmer moves the creature they hit with their pitchfork up to 5 feet, and the target falls [[conditions#prone|prone]]. The target can attempt a DC 13 Reflex save to avoid falling [[conditions#prone|prone]], and avoids being moved altogether on a critical success."
abilities_top:
  - name: Items
