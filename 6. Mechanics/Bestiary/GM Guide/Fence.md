...
abilities_bot:
  ...
  - name: "Scoundrel's Feint"
    desc: "  When the fence successfully [[Feint|Feints]], their target is [[6. Mechanics/Rules/conditions.md#Flat-footed|flat-footed]] against the fence's attacks until the end of the fence's next turn. On a critical success, the target is [[6. Mechanics/Rules/conditions.md#Flat-footed|flat-footed]] against all attacks until the end of the fence's next turn."
  - name: "Sneak Attack"
    desc: "  The fence deals an extra 2d6 (2d6) precision damage to [[6. Mechanics/Rules/conditions.md#Flat-footed|flat-footed]] creatures."
