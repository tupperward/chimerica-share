...
abilities_mid:
  - name: "Kneecapper"
    desc: "⬲ __Trigger__ A Medium creature within the nuglub's reach leaves a square during its move action __Effect__  The nuglub lashes out at the triggering creature's knees and tries to knock them [[conditions#prone|prone]]. The nuglub makes an [[Acrobatics]] check against the creature's Reflex DC. On a success, the target falls and lands [[conditions#prone|prone]]."
abilities_bot:
  - name: "Sneak Attack"
    desc: "  A nuglub's [[Strike|Strikes]] deal an additional 1d6 (1d6) precision damage to [[6. Mechanics/Rules/conditions.md#Flat-footed|flat-footed]] targets, or 1d10 (1d10) if the target is [[conditions#prone|prone]]."
