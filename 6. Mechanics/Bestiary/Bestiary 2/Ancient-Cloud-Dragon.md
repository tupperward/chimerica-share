...
abilities_bot:
  ...
  - name: "Thundering Bite"
    desc: "  An ancient cloud dragon's jaws [[Strike]] creates a deafening clap of thunder when it damages a foe. A creature that takes damage from the dragon's jaws [[Strike]] must succeed at a DC 41 Fortitude save or be [[conditions#deafened|deafened]] for 1 minute (or permanently on a critical failure)."
