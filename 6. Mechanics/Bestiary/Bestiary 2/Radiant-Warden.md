...
abilities_mid:
  - name: "Gatekeeper Aura"
    desc: " ([[abjuration]], [[aura]], [[occult]]);  60 feet. A creature that uses a teleportation ability within the aura's emanation or enters it via a teleportation ability must succeed a DC 38 Will save or become [[conditions#sickened|sickened 1]] and have its destination changed to a point of the radiant warden's choosing within the emanation. On a successful save, the creature arrives as intended but is still [[conditions#sickened|sickened 1]]."
abilities_bot:
  - name: "Orrery"
