...
abilities_bot:
  ...
  - name: "Impaling Chain"
    desc: "  When the evangelist critically hits with a chain [[Strike]], the target is impaled and anchored in place, becoming [[conditions#grabbed|grabbed]] by the chain. The creature is unable to recover from [[conditions#persistent damage|persistent bleed damage]] until it gets free (DC 25 [[Escape]])."
...
attacks:
  - name: Melee
    desc: "⬻ chain +17 ([[disarm]], [[evil]], [[magical]], [[reach|reach 10 feet]], [[trip]]); __Damage__ 2d8+7 (2d8+7) piercing plus 1d6 (1d6) [[conditions#persistent damage|persistent bleed]] and impaling chain"
