...
abilities_bot:
  - name: "Clinging Suckers"
    desc: "  When a grindylow Grabs a creature larger than itself, it attaches to that creature. The [[conditions#grabbed|grabbed]] creature is not [[conditions#immobilized|immobilized]], but if it moves, the grindylow moves with it. If the creature is Medium or smaller, it takes a –5-foot status penalty to its Speeds while the grindylow is attached. The grindylow is [[6. Mechanics/Rules/conditions.md#Flat-footed|flat-footed]] while it is attached to a creature."
  - name: "Jet"
