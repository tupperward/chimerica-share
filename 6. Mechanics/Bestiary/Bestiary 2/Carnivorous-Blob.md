...
abilities_bot:
  - name: "Carnivorous Blob Acid"
    desc: "  A carnivorous blob's acid damages only flesh—not bone, stone, wood, or other materials— but is nonetheless devastating. Whenever a creature takes damage from this acid, it must succeed at a DC 33 Fortitude save or become [[conditions#drained|drained 1]] ([[conditions#drained|drained 2]] on a critical failure). On each subsequent failure, the [[conditions#drained|drained]] condition value increases by 1 (or by 2 on a critical failure), to a maximum of [[conditions#drained|drained 4]]."
  - name: "Constrict"
