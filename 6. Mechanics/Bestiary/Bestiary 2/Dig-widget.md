...
abilities_bot:
  ...
  - name: "Sneak Attack"
    desc: "  A dig-widget's [[Strike|Strikes]] deal an additional 1d6 (1d6) precision damage to [[6. Mechanics/Rules/conditions.md#Flat-footed|flat-footed]] creatures."
...
attacks:
  - name: Melee
    desc: "⬻ drill +14 ([[fatal|fatal d10]], [[finesse]]); __Damage__ 2d6+4 (2d6+4) piercing plus 1d6 (1d6) [[conditions#persistent damage|persistent bleed]]"
  - name: Melee
