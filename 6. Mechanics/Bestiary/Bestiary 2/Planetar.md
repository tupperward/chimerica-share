...
abilities_bot:
  - name: "Blade of Justice"
    desc: "⬺  The planetar makes a greatsword [[Strike]] against a target it detects as evil. If the target is evil, the [[Strike]] deals three extra weapon damage dice and deals 1d6 (1d6) [[conditions#persistent damage|persistent good damage]] to the target. The planetar can convert all the physical damage from the attack into good damage."
  - name: "Change Shape"
