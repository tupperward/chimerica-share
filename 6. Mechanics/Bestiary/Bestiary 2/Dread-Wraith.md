...
abilities_mid:
  - name: "Draining Presence"
    desc: " ([[aura]], [[negative]]);  10 feet. A creature entering the aura must succeed at a DC 26 Fortitude save or become [[conditions#drained|drained 1]]. It recovers after it has been out of the aura for 1 minute. This [[conditions#drained|drained]] condition value is cumulative with the [[conditions#drained|drained]] value caused by drain life, but not with multiple draining presence auras. A creature that succeeds at its save is temporarily immune to draining presence for 24 hours."
