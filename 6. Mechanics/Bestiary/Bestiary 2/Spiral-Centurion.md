...
abilities_mid:
  - name: "Top-Heavy"
    desc: "  A spiral centurion's top-like design makes it susceptible to effects that would cause it to fall [[conditions#prone|prone]]. The DC of any attempt to knock the spiral centurion [[conditions#prone|prone]] is reduced by 5. If the spiral centurion attempts a check or saving throw to resist being knocked [[conditions#prone|prone]], it takes a –5 status penalty. A spiral centurion that has been knocked [[conditions#prone|prone]] can't use any actions other than to attempt to [[Stand]], but it must succeed at a DC 30 [[Acrobatics]] check to do so."
abilities_bot:
  - name: "Hurl Blade"
