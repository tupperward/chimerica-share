...
abilities_bot:
  - name: "Debilitating Bite"
    desc: " ([[curse]], [[occult]]);  A creature that takes damage from a denizen's bite must succeed at a DC 27 Fortitude save or become [[conditions#clumsy|clumsy 1]]. Each time a target fails an additional save against this ability, the condition value increases by 1 (to a maximum of [[conditions#clumsy|clumsy 4]]). This condition value decreases by 1 every 24 hours."
  - name: "Leng Ruby"
...
attacks:
  - name: Melee
    desc: "⬻ kukri +18 ([[agile]], [[finesse]], [[magical]], [[trip]]); __Damage__ 2d6+6 (2d6+6) slashing plus 1d6 (1d6) [[conditions#persistent damage|persistent bleed]]"
  - name: Melee
