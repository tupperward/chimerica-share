...
abilities_bot:
  - name: "Hallucinatory Brine"
    desc: " ([[arcane]], [[illusion]], [[mental]]);  A creature hit by the vaspercham's [[Strike|Strikes]] or Mindwarping Tide must attempt a DC 38 Fortitude save. On a failure, the creature is overwhelmed with phantasmal visions, becoming [[conditions#confused|confused]] for 1 round (1 minute on a critical failure)."
