...
abilities_bot:
  ...
  - name: "Wrap in Coils"
    desc: "⬻ __Requirements__ The behir has a creature either [[conditions#restrained|restrained]] or [[conditions#grabbed|grabbed]] in its jaws  __Effect__  The behir moves the creature into its coils, freeing its jaws. The creature remains [[conditions#grabbed|grabbed]] and takes 1d6+6 (1d6+6) slashing damage. The behir's coils can hold as many creatures as will fit in its space."
