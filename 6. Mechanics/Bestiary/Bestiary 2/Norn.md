...
abilities_bot:
  ...
  - name: "Sever Fate"
    desc: " ([[necromancy]], [[occult]]);  When a norn deals negative damage with a [[Strike]], she regains 10 Hit Points. The target must succeed at a DC 39 Fortitude save or become [[conditions#drained|drained 1]] ([[conditions#drained|drained 2]] on a critical failure). Further negative damage dealt by the norn increases the [[conditions#drained|drained]] condition value by 1 on a failed save (or by 2 on a critical failure), to a maximum of [[conditions#drained|drained 4]]."
  - name: "Shift Fate"
