...
abilities_mid:
  ...
  - name: "Conjuration"
    desc: "  A cloud of fog appears in a 5-foot burst centered on a corner of the dweomercat's space. Anything in the cloud is [[conditions#concealed|concealed]]."
  - name: "Divination"
  ...
  - name: "Illusion"
    desc: "  The dweomercat becomes [[conditions#invisible|invisible]]. This effect ends if the dweomercat uses a [[conditions#hostile|hostile]] action, in addition to the normal end conditions."
  - name: "Necromancy"
...
abilities_bot:
  ...
  - name: "Pounce"
    desc: "⬻  The dweomercat [[Stride|Strides]] and makes a [[Strike]] at the end of that movement. If the dweomercat began this action [[conditions#hidden|hidden]], it remains [[conditions#hidden|hidden]] until after this ability's [[Strike]]."
