...
abilities_bot:
  - name: "Pounce"
    desc: "⬻  The giant solifugid [[Stride|Strides]] and makes a [[Strike]] at the end of that movement. If the giant solifugid began this action [[conditions#hidden|hidden]], it remains [[conditions#hidden|hidden]] until after this ability's [[Strike]]."
  - name: "Rend"
    desc: "⬻ ([[claw]]); "
