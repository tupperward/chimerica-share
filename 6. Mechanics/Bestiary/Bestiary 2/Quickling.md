...
abilities_mid:
  - name: "Slow Susceptibility"
    desc: "  The quickling takes a –2 status penalty to saving throws against effects that cause the [[conditions#slowed|slowed]] condition. If the quickling ever becomes [[conditions#slowed|slowed]], they lose their supernatural speed, can't Fade from View, and become [[conditions#sickened|sickened 1]] for the duration of the slow. They also can't reduce this [[conditions#sickened|sickened]] condition for the duration of the [[conditions#slowed|slowed]] effect."
  - name: "Can't Catch Me"
...
abilities_bot:
  - name: "Sneak Attack"
    desc: "  The quickling's [[Strike|Strikes]] deal an extra 1d6 (1d6) precision damage to [[6. Mechanics/Rules/conditions.md#Flat-footed|flat-footed]] creatures."
