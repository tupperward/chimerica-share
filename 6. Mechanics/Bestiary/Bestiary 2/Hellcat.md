...
abilities_mid:
  - name: "Fade into the Light"
    desc: "⬲ ([[divine]], [[illusion]]); __Trigger__ The hellcat begins its turn in bright light __Effect__  The hellcat becomes [[conditions#invisible|invisible]] until its no longer in bright light. If the hellcat uses a [[conditions#hostile|hostile]] action, the invisibility ends after that [[conditions#hostile|hostile]] action is completed."
abilities_bot:
  - name: "Fearful Attack"
    desc: "  The hellcat deals an additional 1d6 (1d6) precision damage to [[conditions#frightened|frightened]] creatures."
