...
abilities_mid:
  - name: "Cling"
    desc: "⬲ __Trigger__ A creature leaves the swarm's space __Effect__  The swarm takes 1d6 (1d6) damage as ticks cling to the creature and continue biting, dealing 3d6 (3d6) [[conditions#persistent damage|persistent piercing damage]]. Immersion in water reduces the DC of the flat check to end this [[conditions#persistent damage|persistent damage]] to 5, and any area damage dealt to the creature destroys these clinging ticks."
abilities_bot:
  - name: "Swarming Bites"
