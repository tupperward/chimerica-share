...
abilities_bot:
  ...
  - name: "Volcanic Purge"
    desc: "⬻  If the next action the dragon uses is Breath Weapon, the magma clings to those it damages. Each creature that fails its save against the Breath Weapon takes 4d6 (4d6) [[conditions#persistent damage|persistent fire damage]], and as long as it has this [[conditions#persistent damage|persistent fire damage]], it also takes a –10-foot status penalty to its Speeds."
