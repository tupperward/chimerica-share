...
abilities_bot:
  - name: "Poison Gasp"
    desc: "⬻  The tatzlwyrm belches a puff of poisonous vapor into the face of an adjacent creature, which must attempt a DC 15 Fortitude save; the creature takes a –2 circumstance penalty to this save if it's [[conditions#grabbed|grabbed]] or [[6. Mechanics/Rules/conditions.md#Flat-footed|flat-footed]]. The tatzlwyrm can't use Poison Gasp again for 2 rounds.\n__Critical Success__ The target is unaffected.\n__Success__ The target is [[conditions#sickened|sickened 1]].\n__Failure__ The target takes 2d6 (2d6) poison damage and is [[conditions#enfeebled|enfeebled 1]] for 1 round.\n__Critical Failure__ The target takes 4d6 (4d6) poison damage and is [[conditions#enfeebled|enfeebled 1]] for 1 minute."
