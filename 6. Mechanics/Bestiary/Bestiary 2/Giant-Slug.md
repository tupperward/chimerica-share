...
abilities_bot:
  ...
  - name: "Mucus"
    desc: "  Any creature hit by the giant slug or that moves into its mucus trail is coated in sticky, caustic mucus. It takes 1d4 (1d4) [[conditions#persistent damage|persistent acid damage]] and takes a –5-foot status penalty to its Speeds while the damage persists."
  - name: "Mucus Trail"
