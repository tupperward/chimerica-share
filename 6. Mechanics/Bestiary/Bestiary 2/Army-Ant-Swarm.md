...
abilities_mid:
  - name: "Cling"
    desc: "⬲ __Trigger__ A creature leaves the swarm's space __Effect__  The swarm takes 1d6 (1d6) damage as ants cling to the creature and continue biting, dealing 3d6 (3d6) [[conditions#persistent damage|persistent piercing damage]]. High winds or immersion in water reduces the DC of the flat check to end this [[conditions#persistent damage|persistent damage]] to 5. Any area damage dealt to the creature destroys these clinging ants."
abilities_bot:
  - name: "Swarming Bites"
