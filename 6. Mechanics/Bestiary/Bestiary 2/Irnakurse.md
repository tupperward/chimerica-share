...
abilities_bot:
  - name: "Mind Lash"
    desc: " ([[emotion]], [[enchantment]], [[mental]], [[occult]]);  A non-evil creature hit by an irnakurse's tentacle is overwhelmed with corrupted images of a ruined life and must succeed at a DC 28 Will save or be [[conditions#stunned|stunned 2]] (or [[conditions#stunned|stunned 4]] on a critical failure). After attempting this save, a creature is temporarily immune to Mind Lash for 24 hours."
  - name: "Rend"
    desc: "⬻ ([[tentacle]]); "
  - name: "Soul Scream"
  ...
  - name: "Sustain Soul"
    desc: "  Scream for up to 6 rounds; each time it does, it repeats the effect.\n__Critical Success__ The creature is unaffected, and is temporarily immune to Soul Scream for 24 hours.\n__Success__ The creature is [[conditions#stupefied|stupefied 1]] for 1 round.\n__Failure__ The creature is [[conditions#stupefied|stupefied 1]]. Further failed saves against Soul Scream increase the condition value by 1, to a maximum of [[conditions#stupefied|stupefied 4]]. Each time the character gets a full night's rest, the [[conditions#stupefied|stupefied]] condition gained from Soul Scream decreases by 1.\n__Critical Failure__ As failure, except the [[conditions#stupefied|stupefied]] value increases by 2 instead of by 1."
