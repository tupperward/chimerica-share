...
abilities_bot:
  - name: "Ferocity"
    desc: "⬲  When the orc is reduced to 0 Hit Points, they can use their reaction to remain conscious with 1 Hit Point, but they gain the [[conditions#wounded|wounded 1]] condition (or increases the [[conditions#wounded|wounded]] value by 1 if they already have that condition). The orc can't use this ability at [[conditions#wounded|wounded 3]]."
  - name: "Stride"
    desc: "⬻  25 feet"
  - name: "Melee Strike"
