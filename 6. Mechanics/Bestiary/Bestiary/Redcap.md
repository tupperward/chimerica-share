...
abilities_bot:
  ...
  - name: "Stomp"
    desc: "⬻  The redcap [[Stride|Strides]] up to half its Speed and makes a boot [[Strike]] at any point during that movement. If the boot [[Strike]] hits a [[conditions#prone|prone]] creature, it deals an extra 2d6 (2d6) [[conditions#persistent damage|persistent bleed damage]]."
