...
abilities_bot:
  - name: "Aquatic Ambush"
    desc: "⬻  35 feet."
  - name: "Death Roll"
    desc: "⬻ ([[attack]]); __Requirements__ The crocodile must have a creature [[conditions#grabbed|grabbed]].  __Effect__  The crocodile tucks its legs and rolls rapidly, twisting its victim. It makes a jaws [[Strike]] with a +2 circumstance bonus to the attack roll against the [[conditions#grabbed|grabbed]] creature. If it hits, it also knocks the creature [[conditions#prone|prone]]. If it fails, it releases the creature."
  - name: "Deep Breath"
