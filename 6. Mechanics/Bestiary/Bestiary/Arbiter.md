...
abilities_bot:
  - name: "Electrical Burst"
    desc: "⬺ ([[divine]], [[electricity]], [[evocation]]);  The arbiter releases an electrical burst from its body that deals 3d6 (3d6) electricity damage (DC 17 basic Reflex save). Following such a burst, the arbiter becomes [[conditions#stunned|stunned]] for 24 hours."
