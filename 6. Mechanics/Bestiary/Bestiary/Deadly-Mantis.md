...
abilities_bot:
  ...
  - name: "Rending Mandibles"
    desc: "⬻  The mantis makes a mandibles [[Strike]] against a creature it has [[conditions#grabbed|grabbed]]. If that [[Strike]] hits and the creature is wearing armor with Hardness 12 or lower, the armor is [[conditions#broken|broken]]. This [[Strike]] doesn't further damage armor that's already [[conditions#broken|broken]]."
  - name: "Sudden Strike"
    desc: "  On the first round of combat, creatures that haven't acted are [[6. Mechanics/Rules/conditions.md#Flat-footed|flat-footed]] to the giant mantis."
