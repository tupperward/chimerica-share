...
abilities_bot:
  - name: "Captive Rake"
    desc: "⬻ __Requirements__ A creature is [[conditions#grabbed|grabbed]] in the glabrezu's pincer.  __Effect__  The glabrezu pulls the [[conditions#grabbed|grabbed]] creature up to 5 feet closer, then makes two claw [[Strike|Strikes]] against it. Those [[Strike|Strikes]] count as one attack when determining a treachery demon's multiple attack penalty, and the penalty doesn't increase until after both [[Strike|Strikes]]."
