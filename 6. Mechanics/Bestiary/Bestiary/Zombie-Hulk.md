...
abilities_bot:
  - name: "Corpse Throwing"
    desc: "  A zombie hulk can throw corpses at foes. While any Medium dead body will do, they sometimes throw [[zombie shambler|zombie shamblers]], who take just as much damage from being thrown as the target they hit. A thrown shambler lands [[conditions#prone|prone]], but if it's not destroyed, it can rise and use other actions normally."
  - name: "Wide Swing"
