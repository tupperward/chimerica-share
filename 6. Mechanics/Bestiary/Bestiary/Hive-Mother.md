...
abilities_bot:
  ...
  - name: "Frenzy Pheromone"
    desc: "⬺  The hive mother unleashes a pheromone that causes all other ankhravs within a 100-foot emanation to become [[conditions#quickened|quickened 1]] until the start of the hive mother's next turn, and they can use the extra action only for [[Burrow]], [[Stride]], or [[Strike]] actions. The hive mother can't unleash the pheromone again for 1d4 (1d4) rounds."
  - name: "Spray Acid"
    desc: "⬺ ([[acid]]);  The hive mother spews acid in a 60-foot cone, dealing 8d6 (8d6) acid damage and 1d6 (1d6) [[conditions#persistent damage|persistent acid damage]] (DC 26 basic Reflex save). It can't spew acid again for 1d4 (1d4) rounds."
