...
abilities_bot:
  ...
  - name: "Pounce"
    desc: "⬻  The lion [[Stride|Strides]] and makes a [[Strike]] at the end of that movement. If the lion began this action [[conditions#hidden|hidden]], it remains [[conditions#hidden|hidden]] until after the ability's [[Strike]]."
  - name: "Sneak Attack"
    desc: "  The lion deals 1d6 (1d6) extra precision damage to [[6. Mechanics/Rules/conditions.md#Flat-footed|flat-footed]] creatures."
