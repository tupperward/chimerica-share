...
abilities_bot:
  ...
  - name: "Consume Memories"
    desc: " ([[mental]], [[occult]]);  When a veiled master makes a fangs [[Strike]] against a creature, it can consume some of that creature's memories. The target must succeed at a DC 37 Fortitude saving throw or become [[conditions#stupefied|stupefied 1]]. A veiled master regains 5 Hit Points each time it successfully consumes memories. When a veiled master consumes memories, it learns some of the creature's memories (subject to the GM's discretion)."
  ...
  - name: "Thoughtlance"
    desc: " ([[curse]], [[enchantment]], [[occult]]);  A creature touched by the veiled master's tentacles, whether those tentacles deal damage or not, must attempt a DC 34 Will save, becoming [[conditions#slowed|slowed 1]] on a failure or [[conditions#slowed|slowed 2]] on a critical failure. Each time the affected creature ends its turn, its [[conditions#slowed|slowed]] value decreases by 1."
