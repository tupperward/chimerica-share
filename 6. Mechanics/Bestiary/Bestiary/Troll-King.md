...
abilities_mid:
  - name: "Attack of Opportunity"
    desc: "⬲ "
  - name: "Vigorous Shake"
    desc: "⬲ __Trigger__ The troll king takes [[conditions#persistent damage|persistent acid]] or fire damage. __Effect__  The troll king shakes itself to remove persistent [[acid]] or [[fire]] effects. The troll king immediately attempts a DC 15 flat check to end the [[conditions#persistent damage|persistent damage]] that triggered this reaction. If the troll king succeeds at this check, it can immediately use Primordial Roar as part of this reaction."
abilities_bot:
  - name: "Rend"
    desc: "⬻ ([[claw]]); "
