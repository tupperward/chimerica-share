...
abilities_bot:
  - name: "Armor of Flames"
    desc: "⬻  The salamander stokes its internal flames. Until the start of its next turn, it gains a +2 circumstance bonus to AC, and when an adjacent creature touches it or hits it with a physical attack, that creature takes 2d6 (2d6) [[conditions#persistent damage|persistent fire damage]] unless it succeeds at a DC 25 Reflex save."
  - name: "Constrict"
