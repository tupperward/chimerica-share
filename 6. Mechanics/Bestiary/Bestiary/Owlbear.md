...
abilities_bot:
  ...
  - name: "Gnaw"
    desc: "⬻ __Requirements__ The owlbear has a creature [[conditions#grabbed|grabbed]] with its talons.  __Effect__  The owlbear attempts to disembowel the creature with a beak [[Strike]]. If the [[Strike]] hits, the target must attempt a DC 22 Will save.\n__Critical Success__ The target is unaffected.\n__Success__ The target is [[conditions#sickened|sickened 1]].\n__Failure__ The target is [[conditions#sickened|sickened 1]] and [[conditions#slowed|slowed 1]] as long as it remains [[conditions#sickened|sickened]]."
