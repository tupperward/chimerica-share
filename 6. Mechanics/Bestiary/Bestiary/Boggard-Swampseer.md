...
abilities_bot:
  - name: "Destructive Croak"
    desc: "⬺ ([[sonic]]);  The swampseer utters a powerful croak that deals 4d6 (4d6) sonic damage to any non-boggard within a 15-foot emanation (DC 19 basic Fortitude save); any creature with the [[conditions#frightened|frightened]] condition takes additional sonic damage equal to twice the value of their [[conditions#frightened|frightened]] condition. The boggard can't use."
  - name: "Destructive"
