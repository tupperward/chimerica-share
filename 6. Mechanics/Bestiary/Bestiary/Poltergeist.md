...
abilities_bot:
  - name: "Frighten"
    desc: "⬻ ([[concentrate]], [[emotion]], [[fear]], [[incapacitation]], [[mental]]); __Requirements__ The poltergeist must be [[conditions#invisible|invisible]].  __Effect__  The poltergeist becomes visible, appearing as a skeletal, ghostlike humanoid. Each creature within 30 feet must attempt a DC 21 Will save, becoming [[conditions#frightened|frightened 2]] on a failure. On a critical failure, it's also [[conditions#fleeing|fleeing]] for as long as it's [[conditions#frightened|frightened]]. On a success, the creature is temporarily immune for 1 minute. At the start of its next turn, the poltergeist becomes [[conditions#invisible|invisible]] again."
