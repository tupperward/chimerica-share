...
abilities_mid:
  - name: "Golem Antimagic"
    desc: "  harmed by cold and water (5d10 (5d10), 2d8 (2d8) from areas and [[conditions#persistent damage|persistent damage]]); healed by acid (area 2d8 (2d8) HP); [[conditions#slowed|slowed]] by earth."
...
abilities_bot:
  - name: "Impose Paralysis"
    desc: "⬲ ([[incapacitation]]); __Trigger__ The stone golem hits a [[conditions#slowed|slowed]] creature. __Effect__  The creature must succeed at a DC 30 Fortitude save or become [[conditions#paralyzed|paralyzed]] for 1 round."
  ...
  - name: "Slowing Pulse"
    desc: "⬻ ([[arcane]], [[concentrate]], [[transmutation]]);  Each creature in a 10-foot emanation must succeed at a DC 30 Fortitude save or be [[conditions#slowed|slowed 1]] for 1 minute. The golem can't use Slowing Pulse again for 1d4 (1d4) rounds."
