...
abilities_bot:
  ...
  - name: "Pounce"
    desc: "⬻  The elananx [[Stride|Strides]] and makes a [[Strike]] at the end of that movement. If the elananx began this action [[conditions#hidden|hidden]], it remains [[conditions#hidden|hidden]] until after the attack."
  - name: "Elemental, Air"
