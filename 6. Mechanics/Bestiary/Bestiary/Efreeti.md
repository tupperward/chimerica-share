...
abilities_bot:
  - name: "Burning Grasp"
    desc: " ([[fire]]);  When the efreeti grabs a creature, that creature takes 2d6 (2d6) fire damage, and takes 2d6 (2d6) fire damage at the end of each of its turns as long as it remains [[conditions#grabbed|grabbed]]."
  - name: "Change Size"
  ...
  - name: "Combat Grab"
    desc: "⬻ __Requirements__ The efreeti has one hand free.  __Effect__  The efreeti makes a melee [[Strike]] while keeping one hand free. If the [[Strike]] hits, the target is [[conditions#grabbed|grabbed]] in the efreeti's free hand."
abilities_top:
  - name: Items
