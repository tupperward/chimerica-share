...
abilities_mid:
  ...
  - name: "Freezing Blood"
    desc: "⬲ ([[arcane]], [[cold]]); __Trigger__ An adjacent creature deals piercing or slashing damage to the dragon. __Effect__  The dragon's blood sprays on the creature, dealing 2d6 (2d6) cold damage. A creature that takes cold damage in this way is [[conditions#slowed|slowed 1]] for 1 round."
abilities_bot:
  - name: "Breath Weapon"
  ...
  - name: "Ground Slam"
    desc: "⬻  The dragon slams into the ground. It can do this if it's on the ground or Flying within 10 feet of the ground. Each creature on the ground within 10 feet must succeed at a DC 29 Reflex save or fall [[conditions#prone|prone]] and take 3d6 (3d6) bludgeoning damage. The dragon can then [[Step]]."
  - name: "Ice Climb"
