...
abilities_bot:
  - name: "Breath Weapon"
    desc: "⬺ ([[arcane]], [[fire]]);  The fire mephit breathes flames in a 15-foot cone that deals 2d4 (2d4) fire and 1d4 (1d4) [[conditions#persistent damage|persistent fire damage]] to each creature within the area (DC 17 basic Reflex save). The fire mephit can't use Breath Weapon again for 1d4 (1d4) rounds."
