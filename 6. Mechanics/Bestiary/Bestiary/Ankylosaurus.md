...
abilities_bot:
  - name: "Punishing Tail"
    desc: "  A creature struck by the ankylosaurus's tail must attempt a DC 24 Fortitude save. On a failure, it's [[conditions#slowed|slowed 1]] until the end of its next turn; on a critical failure, it's [[conditions#stunned|stunned]] until the end of its next turn."
  - name: "Trample"
