...
abilities_mid:
  - name: "End the Charade"
    desc: "⬲ ([[attack]]); __Trigger__ The doppelganger is transformed with Change Shape and another creature moves adjacent to it or takes a [[conditions#hostile|hostile]] action against it. __Effect__  The doppelganger reverts to its natural form and can make a [[Strike]] against the triggering creature. If the creature was unaware the doppelganger was in disguise, that creature is [[6. Mechanics/Rules/conditions.md#Flat-footed|flat-footed]] against this attack."
abilities_bot:
  - name: "Change Shape"
