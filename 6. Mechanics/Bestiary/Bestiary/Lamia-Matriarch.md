...
abilities_bot:
  ...
  - name: "Matriarch's Caress"
    desc: "⬺ ([[curse]], [[enchantment]], [[mental]], [[occult]]);  The lamia touches a creature, who must succeed at a DC 28 Will save or become [[conditions#stupefied|stupefied 1]] (or [[conditions#stupefied|stupefied 2]] on a critical failure). If the target fails additional saves against this ability, the condition value increases by 1 (or 2 if it critically fails; to a maximum of [[conditions#stupefied|stupefied 4]]). This condition value decreases by 1 every 24 hours."
abilities_top:
  - name: Items
