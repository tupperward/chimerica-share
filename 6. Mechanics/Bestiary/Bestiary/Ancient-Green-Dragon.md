...
abilities_mid:
  ...
  - name: "Miasma"
    desc: " ([[aura]], [[poison]]);  20 feet. After the dragon uses its Breath Weapon, a cloud of poison gas continues to emanate from its body for 1 round. Any creature that ends its turn in the miasma takes 4d6 (4d6) poison damage (DC 37 basic Fortitude save). Any creature in the miasma is [[conditions#concealed|concealed]] and treats other creatures as [[conditions#concealed|concealed]]. The dragon can see through this concealment."
  - name: "Twisting Tail"
