...
abilities_mid:
  - name: "Quick Capture"
    desc: "⬲ __Trigger__ A creature hits or touches the flytrap. __Effect__  The flytrap makes a leaf [[Strike]] against the triggering creature. If it hits, the creature is [[conditions#grabbed|grabbed]] in that leaf."
abilities_bot:
