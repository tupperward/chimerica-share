...
abilities_bot:
  - name: "Hidden Movement"
    desc: "  If the deep gnome scout starts its turn [[conditions#undetected|undetected]] or [[conditions#hidden|hidden]] to a creature, that creature is [[6. Mechanics/Rules/conditions.md#Flat-footed|flat-footed]] against the deep gnome scout's attacks until the end of the turn."
abilities_top:
  - name: Items
