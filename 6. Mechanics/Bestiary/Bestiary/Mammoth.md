...
abilities_bot:
  ...
  - name: "Grabbing Trunk"
    desc: "  A Medium or smaller creature hit by the elephant's trunk is [[conditions#grabbed|grabbed]]. If the elephant moves, it can bring the [[conditions#grabbed|grabbed]] creature along with it."
  - name: "Trample"
