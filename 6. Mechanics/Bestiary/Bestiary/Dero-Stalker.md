...
abilities_mid:
  ...
  - name: "Nimble Dodge"
    desc: "⬲ __Requirements__ The dero stalker is not [[conditions#encumbered|encumbered]]. __Trigger__ A creature targets the dero with an attack and the dero can see the attacker. __Effect__  The dero dodges out of the way, gaining a +2 circumstance bonus to AC against the triggering attack."
abilities_top:
  - name: Items
    desc: "[[aklys]], [[giant centipede venom]] (4 doses), [[hand crossbow]] (20 [[bolt|bolts]];"
abilities_bot:
  - name: "Sneak Attack"
    desc: "  A dero stalker deals 1d6 (1d6) extra precision damage to [[6. Mechanics/Rules/conditions.md#Flat-footed|flat-footed]] creatures."
