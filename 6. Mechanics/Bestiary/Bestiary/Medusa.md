...
abilities_bot:
  - name: "Focus Gaze"
    desc: "⬻ ([[arcane]], [[concentrate]], [[incapacitation]], [[transmutation]], [[visual]]);  The medusa fixes their glare at a creature they can see within 30 feet. The target must immediately attempt a Fortitude save against the medusa's petrifying gaze. If the creature was already [[conditions#slowed|slowed]] by petrifying gaze before attempting its save, a failed save causes it to be [[conditions#petrified|petrified]] permanently. After attempting its save, the creature is then temporarily immune until the start of the medusa's next turn."
  - name: "Serpent Venom"
    desc: " ([[poison]]);  __Saving Throw__ DC 25 Fortitude. __Maximum Duration__ 6 rounds __Stage 1__ 1d6 (1d6) poison damage and [[conditions#enfeebled|enfeebled 1]] (1 round) __Stage 2__ 2d6 (2d6) poison damage and [[conditions#enfeebled|enfeebled 2]] (1 round)"
