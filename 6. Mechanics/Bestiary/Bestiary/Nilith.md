...
abilities_bot:
  - name: "Mind Crush"
    desc: "⬻ ([[enchantment]], [[mental]], [[occult]]); __Requirements__ The nilith has a creature [[conditions#grabbed|grabbed]].  __Effect__  The nilith reaches into the mind of the [[conditions#grabbed|grabbed]] creature and implants disjointed images of the victim's worst fears and nightmares. The [[conditions#grabbed|grabbed]] creature takes 6d6 (6d6) mental damage (DC 31 basic Will save). On a critical failure, the target is also affected as though by feeblemind, and it must attempt a second Will save against that effect."
