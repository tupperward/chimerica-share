...
abilities_bot:
  - name: "Bonecrunching Bite"
    desc: "  A creature that is critically hit by a hyaenodon must succeed at a DC 20 Fortitude save or become [[conditions#wounded|wounded 1]] as the creature's bones or cartilage are crushed by the beast's jaws."
  - name: "Drag"
    desc: "⬻  The hyena makes a jaws [[Strike]] against a [[conditions#prone|prone]] enemy. If it hits, in addition to dealing damage, the hyena [[Stride|Strides]] up to 10 feet, dragging the enemy along."
  - name: "Pack Attack"
