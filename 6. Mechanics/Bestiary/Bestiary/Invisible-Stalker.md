...
abilities_mid:
  - name: "Naturally Invisible"
    desc: "  The [[conditions#invisible|invisible]] stalker is [[conditions#invisible|invisible]] at all times, though when it takes a [[conditions#hostile|hostile]] action of any kind, it is [[conditions#hidden|hidden]] instead of [[conditions#undetected|undetected]] until the start of its next turn, as the vague outline of its humanoid form is faintly visible for a short period of time."
abilities_bot:
  - name: "Sneak Attack"
    desc: "  The [[conditions#invisible|invisible]] stalker deals 2d6 (2d6) extra precision damage to [[6. Mechanics/Rules/conditions.md#Flat-footed|flat-footed]] creatures."
  - name: "Swift Tracker"
    desc: "  The [[conditions#invisible|invisible]] stalker moves at full Speed while [[Track|Tracking]]."
