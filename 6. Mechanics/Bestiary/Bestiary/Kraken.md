...
abilities_bot:
  ...
  - name: "Ink Cloud"
    desc: "⬻  The kraken emits a cloud of black, venomous ink in an 80-foot emanation. This cloud has no effect outside water. Creatures inside the ink cloud are exposed to kraken ink poison and are [[conditions#undetected|undetected]] while inside the cloud. The kraken can't use Ink Cloud again for 2d6 (2d6) rounds, and the cloud dissipates after 1 minute."
  - name: "Jet"
    desc: "⬻ ([[move]]);  The kraken moves through the water up to 280 feet in a straight line without triggering reactions."
  - name: "Kraken Ink"
    desc: " ([[poison]]);  __Saving Throw__ DC 39 Fortitude. __Maximum Duration__ 10 rounds __Stage 1__ 3d6 (3d6) poison damage and [[conditions#sickened|sickened 1]] (1 round) __Stage 2__ 4d6 (4d6) poison damage and [[conditions#sickened|sickened 2]]. (1 round)"
