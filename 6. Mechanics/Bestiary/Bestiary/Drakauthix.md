...
abilities_bot:
  - name: "Reel In"
    desc: "⬻  The drakauthix pulls all creatures it has [[conditions#grabbed|grabbed 15]] feet closer to itself."
  - name: "Spore Tendrils"
    desc: "⬻  The tendrils that cover the drakauthix's body reach out and infest adjacent creatures, dealing 4d6 (4d6) poison damage and 1d6 (1d6) [[conditions#persistent damage|persistent poison damage]]. A creature can attempt a basic DC 27 Reflex save to reduce this damage, but one [[conditions#grabbed|grabbed]] by the drakauthix takes a –4 circumstance penalty to this save."
