...
abilities_bot:
  - name: "Sinful Bite"
    desc: " ([[arcane]], [[emotion]], [[mental]]);  A creature hit by the jaws of a sinspawn must attempt a DC 18 Will save as it is assailed by sinful thoughts.\n__Success__ [[conditions#sickened|Sickened 1]].\n__Critical Success__ Unaffected.\n__Failure__ [[conditions#sickened|Sickened 2]].\n__Critical Failure__ [[conditions#sickened|Sickened 2]] plus an additional penalty, determined by the sinspawn's sin, while it remains [[conditions#sickened|sickened]]."
  - name: "Sin"
