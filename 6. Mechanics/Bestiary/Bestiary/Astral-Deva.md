...
abilities_mid:
  - name: "Traveler's Aura"
    desc: " ([[abjuration]], [[aura]], [[divine]]);  20 feet. Creatures in the astral deva's aura are protected from ambient environmental damage from any plane, including severe and extreme heat and cold as well as more exotic dangers. The astral deva is never [[6. Mechanics/Rules/conditions.md#Flat-footed|flat-footed]] to creatures within its aura."
...
abilities_bot:
  ...
  - name: "Stunning Strike"
    desc: "⬻ __Requirements__ The astral deva hit a foe earlier this turn with a weapon [[Strike]].  __Effect__  The astral deva makes a weapon [[Strike]] against the foe. On a success, the foe must succeed at a DC 34 Fortitude save or become [[conditions#stunned|stunned 1]]. On a critical failure, the foe is [[conditions#stunned|stunned 2]] instead."
