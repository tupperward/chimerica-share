...
abilities_bot:
  - name: "Constrict"
    desc: "⬻  1d8+9 (1d8+9) bludgeoning, DC 25 ([[conditions#grabbed|grabbed]] by claws only)"
  - name: "Mandibles"
    desc: "⬻ __Requirements__ A creature is [[conditions#grabbed|grabbed]] and [[conditions#paralyzed|paralyzed]] by the chuul's tentacles.  __Effect__  The creature takes 3d6 (3d6) piercing damage."
  - name: "Paralytic Venom"
    desc: " ([[incapacitation]], [[poison]]);  __Saving Throw__ DC 25 Fortitude. __Maximum Duration__ 6 rounds __Stage 1__ [[conditions#paralyzed|paralyzed]]. (1 round)"
  - name: "Tentacle Transfer"
    desc: "⬻ __Requirements__ The chuul has a creature [[conditions#grabbed|grabbed]].  __Effect__  The chuul transfers the [[conditions#grabbed|grabbed]] creature from its claws to its tentacles, or vice versa. A creature is exposed to the chuul's paralytic venom when transferred into the tentacles and at the start of each of the chuul's turns if it remains [[conditions#grabbed|grabbed]] by the tentacles."
